...
{
    $RAs = array();
    $query = 'SELECT A.id, A.RA, status, YEAR(data_entrada) AS ano, MONTH(data_entrada) AS mes, DAY(data_entrada) AS dia, TIME(data_entrada) AS horario FROM alunos AS A
